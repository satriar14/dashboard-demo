              ...
              {!isLoading && riskData.length > 0 && (
                <ResponsiveContainer width="100%" height="100%">
                  <ScatterChart margin={{ top: 20, right: 20, bottom: 20, left: -20 }}>
                    ...
                    <XAxis 
                      type="number" 
                      dataKey="keterlambatan" 
                      name="Rata-rata Terlambat" 
                      unit=" Hari" 
                      label={{ value: 'Waktu (Hari)', position: 'insideBottom', offset: -10, fontSize: 10, fill: '#64748b' }}
                      tick={{ fontSize: 10 }}
                      domain={[0, 'auto']}
                    />
                    <YAxis 
                      ...
                      unit="jt" 
                      label={{ value: 'Nominal (Juta)', angle: -90, position: 'insideLeft', fontSize: 10, fill: '#64748b' }}
                      tick={{ fontSize: 10 }}
                      domain={[0, 'auto']}
                    />
                    <Tooltip 
                          ...
                          return (
                            <div className="bg-white p-3 border border-slate-200 shadow-xl rounded-xl text-[13px]">
                              ...
                              <div className="space-y-1 text-slate-600">
                                <p>Rata-rata Terlambat: <span className="font-bold text-slate-900">{data.keterlambatan} Hari</span></p>
                                <p>Nominal Tunggakan: <span className="font-bold text-rose-600">{formatCurrencyShort(data.tunggakan)}</span></p>
                              </div>
                            </div>
                          );
                        }
                    ...
                    />
                    <Scatter data={riskData} fill={COLORS.danger} fillOpacity={0.6} />
                  </ScatterChart>
                </ResponsiveContainer>
              )}
            </div>
